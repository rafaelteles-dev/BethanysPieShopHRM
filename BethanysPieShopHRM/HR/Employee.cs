...
namespace BethanysPieShopHRM.HR
{
    internal class Employee: IEmployee
    {
        ...
        public int CalculateBonusAndBonusTax(int bonus, int bonusTax)
        {
            bonusTax = 0;
            if (NumberOfHoursWorked > 10)
                bonus *= 2;
            ...
            Console.WriteLine($"The employee gost a bonus of {bonus} and the tax bonus is {bonusTax}");
            return bonus;
        }
        ...
        public double ReceiveWage(bool resetHours = true)
        {
            ...
            Wage = NumberOfHoursWorked * HourlyRate.Value * (1 - taxRate);
